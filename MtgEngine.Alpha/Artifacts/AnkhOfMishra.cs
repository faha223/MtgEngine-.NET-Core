...
namespace MtgEngine.Alpha.Artifacts
{
    ...
    public class AnkhOfMishra : ArtifactCard
    {
        ...
        internal class AnkhOfMishraAbility : EventTriggeredAbility
        {
            ...
            public AnkhOfMishraAbility(PermanentCard source) : base(source, "Whenever a land enters the battlefield, Ankh of Mishra deals 2 damage to that land's controller.")
            {
            }
