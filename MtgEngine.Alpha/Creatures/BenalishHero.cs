...
namespace MtgEngine.Alpha.Creatures
{
    ...
    public class BenalishHero : PermanentCard
    {
        public BenalishHero(Player owner) : base(owner, true, null, new[] { CardType.Creature }, new[] { "Human", "Soldier" }, false, 1, 1, false, false)
        {
