...
namespace MtgEngine.Alpha.Creatures
{
    ...
    public class AirElemental : PermanentCard
    {
        public AirElemental(Player owner) : base(owner, true, null, new[] { CardType.Creature }, new[] { "Elemental" }, false, 4, 4, false, false)
        {
