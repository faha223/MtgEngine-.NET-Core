...
namespace MtgEngine.TestSet.Creatures
{
    ...
    public class FencingAce : PermanentCard
    {
        public FencingAce(Player owner) : base(owner, true, null, new[] { CardType.Creature }, new[] { "Human", "Soldier" }, false, 1, 1, false, false)
        {
