...
namespace MtgEngine.TestSet
{
    ...
    public class Gigantosaurus : PermanentCard
    {
        public Gigantosaurus(Player owner) : base(owner, true, null, new[] { CardType.Creature }, new[] { "Dinosaur" }, false, 10, 10, false, false)
        {
