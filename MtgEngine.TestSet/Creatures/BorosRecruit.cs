...
namespace MtgEngine.TestSet.Creatures
{
    ...
    public class BorosRecruit : PermanentCard
    {
        public BorosRecruit(Player owner) : base(owner, true, null, new[] { CardType.Creature }, new[] { "Goblin", "Soldier"}, false, 1, 1, false, false)
        {
