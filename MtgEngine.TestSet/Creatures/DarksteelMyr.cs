...
namespace MtgEngine.TestSet.Creatures
{
    ...
    public class DarksteelMyr : PermanentCard
    {
        public DarksteelMyr(Player owner) : base(owner, true, null, new[] { CardType.Artifact, CardType.Creature }, new[] { "Myr" }, false, 0, 1, false, false)
        {
