...
namespace MtgEngine.TestSet.Creatures
{
    ...
    public class FortifiedRampart : PermanentCard
    {
        public FortifiedRampart(Player owner) : base(owner, true, null, new[] { CardType.Creature }, new[] { "Wall" }, false, 0, 6, false, false)
        {
